		...
		},
		{
			...
			want: &upgradeable{
				Conditions: []configv1.ClusterOperatorStatusCondition{{
					...
					Message: "Cluster Version overrides is being used to unmanage certain owned resources.",
				}, {
		...
		},
		{
			...
			want: &upgradeable{
				Conditions: []configv1.ClusterOperatorStatusCondition{{
					...
					Message: "Cluster Operator \"default-operator-1\" is not Upgradeable(\"RandomReason\"): some random reason why upgrades are not safe.",
				}, {
		...
		},
		{
			...
			want: &upgradeable{
				Conditions: []configv1.ClusterOperatorStatusCondition{{
					...
					Message: "Multiple Cluster Operators are not upgradeable:\n* Cluster Operator \"default-operator-1\" is not Upgradeable(\"RandomReason\"): some random reason why upgrades are not safe.\n* Cluster Operator \"default-operator-2\" is not Upgradeable(\"RandomReason2\"): some random reason 2 why upgrades are not safe.",
				}, {
					Type:    "UpgradeableClusterOperators",
					Status:  configv1.ConditionFalse,
					Reason:  "ClusterOperatorsNotUpgradeable",
		...
		},
		{
			...
			want: &upgradeable{
				Conditions: []configv1.ClusterOperatorStatusCondition{{
					...
					Message: "Cluster is not Upgradeable due to multiple reasons: ClusterOperatorsNotUpgradeable,ClusterVersionOverridesSet",
				}, {
					Type:    "UpgradeableClusterOperators",
					Status:  configv1.ConditionFalse,
					Reason:  "ClusterOperatorsNotUpgradeable",
